...
> Migrated from `.cursor/rules/about.mdc`. Original Cursor description: Project documentation rule for creating about.md files that explain projects in plain language.
