...
> Migrated from `.cursor/rules/opensync-ecosystem.mdc`. Original Cursor description: OpenSync ecosystem development guidelines for building and maintaining plugins.
