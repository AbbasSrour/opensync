...
> Migrated from `.cursor/rules/convex-write-conflicts.mdc`. Original Cursor description: Guidelines for preventing write conflicts when using React, useEffect, and Convex.
