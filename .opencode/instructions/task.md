...
> Migrated from `.cursor/rules/task.mdc`. Original Cursor description: Guidelines for creating and managing task lists in markdown files to track project progress.
