...
description: Use when quick security audit checklist covering authentication, function exposure, argument validation, row-level access control, and environment variable handling
---

# Convex Security Check

> Migrated from `.claude/skills/convex-security-check.md`.
