---
name: convex-agents
description: Use when building AI agents with the Convex Agent component including thread management, tool integration, streaming responses, RAG patterns, and workflow orchestration
---

# Convex Agents

> Migrated from `.claude/skills/convex-agents.md`.
