...
description: Use when defining and validating database schemas with proper typing, index configuration, optional fields, unions, and migration strategies for schema changes
---

# Convex Schema Validator

> Migrated from `.claude/skills/convex-schema-validator.md`.
