...
description: Use when how to create, structure, and publish self-contained Convex components with proper isolation, exports, and dependency management
---

# Convex Component Authoring

> Migrated from `.claude/skills/convex-component-authoring.md`.
