...
description: Use when patterns for building reactive apps including subscription management, optimistic updates, cache behavior, and paginated queries with cursor-based loading
---

# Convex Realtime

> Migrated from `.claude/skills/convex-realtime.md`.
