...
description: Use when complete file handling including upload flows, serving files via URL, storing generated files from actions, deletion, and accessing file metadata from system tables
---

# Convex File Storage

> Migrated from `.claude/skills/convex-file-storage.md`.
