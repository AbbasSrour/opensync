...
description: Use when schema migration strategies for evolving applications including adding new fields, backfilling data, removing deprecated fields, index migrations, and zero-downtime migration patterns
---

# Convex Migrations

> Migrated from `.claude/skills/convex-migrations.md`.
