...
description: Use when scheduled function patterns for background tasks including interval scheduling, cron expressions, job monitoring, retry strategies, and best practices for long-running tasks
---

# Convex Cron Jobs

> Migrated from `.claude/skills/convex-cron-jobs.md`.
