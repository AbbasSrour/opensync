...
description: Use when external API integration and webhook handling including HTTP endpoint routing, request/response handling, authentication, CORS configuration, and webhook signature validation
---

# Convex HTTP Actions

> Migrated from `.claude/skills/convex-http-actions.md`.
