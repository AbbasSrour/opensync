...
import { PublicSessionPage } from "./pages/PublicSession.tsx";
import { SettingsPage } from "./pages/Settings.tsx";
import { EvalsPage } from "./pages/Evals.tsx";
...
import { SetupIncompleteBanner } from "./components/SetupIncompleteBanner.tsx";
...
`}
        ...
        <p className="text-sm text-zinc-600 mb-6">The page you're looking for doesn't exist.</p>
        <Link
          to="/"
