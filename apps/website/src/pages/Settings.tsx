...
export function SettingsPage() {
  ...
  const isDeletionInProgress =
    currentUser?.deletionStatus === "pending" || currentUser?.deletionStatus === "in_progress";
                ...
                <div className={cn("p-4 rounded-lg border h-full", t.bgCard, t.border)}>
                  ...
                  <div className={cn("text-sm mt-4 space-y-2", t.textSubtle)}>
                    ...
                    <p>
                      ...
                      <span className={t.textDim}>Sync your Codex CLI sessions</span>{" "}
                      <a
                    ...
                    <p>
                      ...
                      <span className={t.textDim}>Sync your Pi sessions</span>{" "}
                      <a
                ...
                <div className={cn("p-4 rounded-lg border h-full", t.bgCard, t.border)}>
                  ...
                  <div className={cn("mt-4 p-3 rounded border", t.bgSecondary, t.borderLight)}>
                    <p className={cn("text-xs", t.textDim)}>
                      Enabling an agent adds it to the Source filter. If no data exists for that
                      tool, it will show empty results when selected.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <section>
              ...
              <div className={cn("p-4 rounded-lg border border-red-500/30 space-y-4", t.bgCard)}>
                ...
                {isDeletionCompleted && (
                  <div className="p-3 rounded border border-emerald-500/50 bg-emerald-500/10">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-sm text-emerald-400">All data deleted successfully</p>
                    </div>
                  </div>
                )}
                ...
                {isDeletionInProgress && currentUser?.deletionProgress && (
                  <div className={cn("p-4 rounded border", t.bgSecondary, t.borderLight)}>
                    <div className="flex items-center gap-2 mb-3">
                      <Loader2 className="h-4 w-4 animate-spin text-amber-400" />
                      <p className={cn("text-sm font-medium", t.textSecondary)}>Deleting data...</p>
                    </div>
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className={t.textSubtle}>{currentUser.deletionProgress.parts}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className={t.textDim}>API Logs:</span>
                        <span className={t.textSubtle}>{currentUser.deletionProgress.apiLogs}</span>
                      </div>
                      <div className="flex justify-between">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className={cn("text-xs mt-1", t.textDim)}>
                      Remove all sessions, messages, and embeddings. Your account will remain
                      active.
                    </p>
                  </div>
                  <button
