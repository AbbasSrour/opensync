    ...
    <>
      <button
        ...
        className={`text-xs transition-colors ${
          isDark ? "text-zinc-600 hover:text-zinc-400" : "text-[#8b7355] hover:text-[#6b6b6b]"
        }`}
      >
        Terms
      </button>
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          />
          <p className={`mt-3 text-sm ${isDark ? "text-zinc-500" : "text-[#6b6b6b]"}`}>
            Signing in...
          </p>
        </div>
      </div>
        ...
        <main className="flex flex-1 items-center">
          <div className="grid w-full gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div className="flex flex-col justify-center">
              ...
              >
                Dashboards for OpenCode, Claude Code, Codex, Cursor, and Factory Droid.
              </h2>
              <p
                className={`mt-3 text-sm sm:text-base leading-relaxed ${isDark ? "text-zinc-300" : "text-[#1a1a1a]"}`}
              >
                Cloud dashboards that sync session activity, tool usage, and token spend. Build and
                export eval datasets across projects.
              </p>
              ...
              >
                <p>
                  <span className={`font-mono ${isDark ? "text-[#c586c0]" : "text-[#9b4d96]"}`}>
                    Sync
                  </span>{" "}
                  sessions from CLI to cloud
                </p>
                <p>
                  <span className={`font-mono ${isDark ? "text-[#EBC101]" : "text-[#8b7355]"}`}>
                    Search
                  </span>{" "}
                  with full text and semantic lookup
                </p>
                <p>
                  <span className={`font-mono ${isDark ? "text-[#EB1301]" : "text-[#a05d3b]"}`}>
                    Private
                  </span>{" "}
                  your data stays in your account.
                </p>
                <p>
                  <span className={`font-mono ${isDark ? "text-[#A3DD2E]" : "text-[#a05d3b]"}`}>
                    Tag
                  </span>{" "}
                  sessions with custom labels for eval organization
                </p>
                <p>
                  <span className={`font-mono ${isDark ? "text-[#9cdcfe]" : "text-[#3d7ea6]"}`}>
                    Export
                  </span>{" "}
                  sessions for evals in DeepEval, OpenAI, or plain text
                </p>
                <p>
                  <span className="text-[#EB5601] font-mono">Delete</span> your data, your control,
                  delete your sessions anytime.
                </p>
              </div>
              ...
              <div
                className={`mt-8 rounded-md border px-5 py-4 ${
                  isDark ? "border-zinc-800 bg-zinc-900/50" : "border-[#e6e4e1] bg-[#f5f3f0]"
                }`}
              >
            ...
            <div className="flex flex-col gap-8">
                  ...
                  <div className="flex-1 p-5">
                    ...
                    >
                      <div className="text-xs">
                        <p className={`mb-1 ${isDark ? "text-zinc-600" : "text-[#8b7355]"}`}>
                          user
                        </p>
                    ...
                    <div className="mt-4 grid grid-cols-4 gap-2 text-center">
                      <div className={`rounded p-2 ${isDark ? "bg-zinc-800/50" : "bg-[#ebe9e6]"}`}>
                        ...
                        <p className={`text-[10px] ${isDark ? "text-zinc-600" : "text-[#8b7355]"}`}>
                          sessions
                        </p>
                      </div>
                      <div className={`rounded p-2 ${isDark ? "bg-zinc-800/50" : "bg-[#ebe9e6]"}`}>
              ...
              >
                ...
                <div className="flex items-end justify-center gap-8 flex-wrap">
                  ...
                  >
                    <img
                      src={isDark ? "/opencode-dark.svg" : "/opencode-light.svg"}
                      alt="OpenCode"
                      className="h-8 w-8"
                    />
