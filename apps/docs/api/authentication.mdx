...
<Steps>
  ...
  <Step title="Copy the key">Copy and securely store your API key. It won't be shown again.</Step>
</Steps>
...
<Warning title="Keep your API key secure">
  - Never commit API keys to version control - Use environment variables to store keys - Rotate keys
  if they may be compromised - Use separate keys for different environments
</Warning>
...
<Info>Contact us if you need higher limits for your use case.</Info>
