...
<Warning title="Deletion is permanent">
  Deleted sessions and their messages, parts, and embeddings are permanently removed from the
  database. Export important sessions before deleting.
</Warning>
...
<CardGroup cols={2}>
  <Card
    ...
    description="Tag and export sessions for evaluation"
  />
  <Card
    title="Context Search"
    href="/dashboard/context"
    description="Find sessions with semantic search"
  />
  <Card
    title="API Reference"
    href="/api/endpoints"
    description="Access sessions programmatically"
  />
</CardGroup>
